...
#bash /vagrant/tz-local/resource/ingress_nginx/update.sh extension-dev es-eks-w tztest.com
...
https://test.extension-dev.es-eks-a.tz.com/
https://devops.extension.es-eks.tz.com/

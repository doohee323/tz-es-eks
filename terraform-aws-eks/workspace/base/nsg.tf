...
//
//# For bastions
//resource "aws_security_group" "es-eks-dev-bastion" {
//  vpc_id = module.vpc.vpc_id
...
//    to_port     = 0
//    protocol    = "-1"
//    cidr_blocks = [local.VPC_CIDR, local.DEVOPS_UTIL_CIDR]
//  }
//  egress {
//    from_port   = 0
//    to_port     = 0
...
//    cidr_blocks = ["0.0.0.0/0"]
//  }
//  ##[ allow only for the cidr_blocks ]######################################################
//  ingress {
//    from_port   = 3306
//    to_port     = 3306
//    protocol    = "tcp"
...
//    cidr_blocks = ["0.0.0.0/0"]
//  }
//  ##[ allow only for tz-es-eks's cidr_blocks ]######################################################
//  tags = {
...
//resource "aws_security_group_rule" "es-eks-dev-bastion-ssh-from-all" {
...
//  security_group_id = aws_security_group.es-eks-dev-bastion.id
//}
//
//resource "aws_security_group_rule" "es-eks-dev-bastion-egress" {
//  type        = "egress"
//  from_port   = "-1"
//  to_port     = "-1"
//  protocol    = "-1"
